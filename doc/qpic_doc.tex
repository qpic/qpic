...
in Section~\ref{sec-qpic}.  We then briefly describe \qpicpy in Sections~\ref{sec-run} and \ref{sec-tools}, including
...
If you wish to install \qpicpy as a single user, add {\tt \$HOME/.local/bin} to
your {\tt \$PATH} and install using
